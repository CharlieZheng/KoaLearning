...
var bootstrap = function (t, e) {
  ...
  function n(t, e) {
    ...
    function t(t) {
      ...
      return { bindType: o.end, delegateType: o.end, handle: function (t) {
    ...
    var t = "alert",
      ...
      }, q(t, null, [{ key: "VERSION", get: function () {
          return "4.0.0-beta.2";
        } }]), t;
    ...
    var t = "carousel",
      ...
      }, q(r, null, [{ key: "VERSION", get: function () {
          return "4.0.0-beta.2";
    ...
    var t = "collapse",
        ...
        var t = this;if (!this._isTransitioning && !e(this._element).hasClass(a.SHOW)) {
          var r, o;if (this._parent && ((r = e.makeArray(e(this._parent).children().children(c.ACTIVES))).length || (r = null)), !(r && (o = e(r).data(n)) && o._isTransitioning)) {
            var l = e.Event(s.SHOW);if (e(this._element).trigger(l), !l.isDefaultPrevented()) {
              r && (i._jQueryInterface.call(e(r), "hide"), o || e(r).data(n, null));var f = this._getDimension();e(this._element).removeClass(a.COLLAPSE).addClass(a.COLLAPSING), this._element.style[f] = 0, this._triggerArray.length && e(this._triggerArray).removeClass(a.COLLAPSED).attr("aria-expanded", !0), this.setTransitioning(!0);var h = function () {
      ...
      }, q(i, null, [{ key: "VERSION", get: function () {
          return "4.0.0-beta.2";
        } }, { key: "Default", get: function () {
          return r;
        } }]), i;
    ...
    for (var e = 1; e < arguments.length; e++) {
      ...
      mt = { placement: "bottom", eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {}, onUpdate: function () {}, modifiers: { shift: { order: 100, enabled: !0, fn: function (t) {
          var e = t.placement,
              n = e.split("-")[0],
              i = e.split("-")[1];if (i) {
            var r = t.offsets,
    ...
    }return ft(t, [{ key: "update", value: function () {
        return L.call(this);
    ...
    var t = "modal",
      ...
      function i(t, n) {
        ...
        var n = this,
          ...
          e(this._backdrop).removeClass(a.SHOW);var o = function () {
      ...
      function i(t, e) {
        ...
        var t = this;if ("none" === e(this.element).css("display")) throw new Error("Please use show on visible elements");var n = e.Event(this.constructor.Event.SHOW);if (this.isWithContent() && this._isEnabled) {
          e(this.element).trigger(n);var r = e.contains(this.element.ownerDocument.documentElement, this.element);if (n.isDefaultPrevented() || !r) return;var o = this.getTipElement(),
              ...
              c = this._getAttachment(a);this.addAttachmentClass(c);var u = !1 === this.config.container ? document.body : e(this.config.container);e(o).data(this.constructor.DATA_KEY, this), e.contains(this.element.ownerDocument.documentElement, this.tip) || e(o).appendTo(u), e(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new _t(this.element, o, { placement: c, modifiers: { offset: { offset: this.config.offset }, flip: { behavior: this.config.fallbackPlacement }, arrow: { element: h.ARROW } }, onCreate: function (e) {
              e.originalPlacement !== e.placement && t._handlePopperPlacementChange(e);
            }, onUpdate: function (e) {
              t._handlePopperPlacementChange(e);
            } }), e(o).addClass(f.SHOW), "ontouchstart" in document.documentElement && e("body").children().on("mouseover", null, e.noop);var d = function () {
    ...
    var t = "popover",
      ...
      }, q(f, null, [{ key: "VERSION", get: function () {
          return "4.0.0-beta.2";
        } }, { key: "Default", get: function () {
          return o;
        } }, { key: "NAME", get: function () {
    ...
    var t = "scrollspy",
      ...
      }, q(n, null, [{ key: "VERSION", get: function () {
          return "4.0.0-beta.2";
        } }, { key: "Default", get: function () {
          return i;
        } }]), n;
      ...
      function t(t) {
        ...
        var t = this;if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass(i.ACTIVE) || e(this._element).hasClass(i.DISABLED))) {
          var o,
            ...
            l && (o = e(l)[0]), this._activate(this._element, a);var u = function () {
